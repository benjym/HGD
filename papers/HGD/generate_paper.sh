...
python void_migration/main.py papers/HGD/json/collapse_stress.json5 # 1
python papers/HGD/post_process/collapse_stress.py
echo "Collapse stress done"

python void_migration/main.py papers/HGD/json/collapse_fill.json5 # 3
python papers/HGD/post_process/collapse_fill.py
echo "Collapse fill done"

python void_migration/main.py papers/HGD/json/collapse_bi.json5 # 3
python papers/HGD/post_process/collapse_bi.py
echo "Collapse bi done"

python void_migration/main.py papers/HGD/json/collapse_poly.json5 # 3
